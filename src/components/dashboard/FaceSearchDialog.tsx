...
export function FaceSearchDialog({ isOpen, onClose, members, onMatchFound }: FaceSearchDialogProps) {
    ...
    const startScan = async (queryImage: File | Blob) => {
        ...
        try {
            ...
            // Note: Ideally this should be cached or pre-computed, but for <50 members it's fast enough.
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Search by Face">
                ...
                {step === 'upload' && (
                    <div className="space-y-6 text-center animate-in fade-in zoom-in duration-300">
                        ...
                        <p className="text-sm text-gray-500 max-w-xs mx-auto">
                            Upload a photo to find who it is in the family tree.
                        </p>
                        ...
                        <div className="flex gap-4 justify-center">
                            ...
                            {/* Camera capture could be added here later */}
                        </div>
                        <input
                            type="file"
                            ref={fileInputRef}
